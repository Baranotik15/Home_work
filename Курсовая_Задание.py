...
#
# User Story:
# Начальные условия (вынести в файл config.json):
#     курс: 26.00
#     кол-во на гривневом счету: 10000.00 UAH
#     кол-во на долларовом счету: 0.00 USD
#     дельта: 0.5
#
...
#     BUY ALL - покупка долларов на все возможные гривны. На гривневом балансе после выполнения этой операции допускается остаток в несколько копеек.
#     SELL ALL - продажа всех долларов. На доллоровом балансе после выполнения этой операции не допускается остаток в несколько центов.
#     NEXT - получить следующий курс
#     RESTART - начать игру с начала (с начальными условиями)
#
# Tech Requirements:
# Минимум три файла: 1) trader.py, 2) config.json 3) Состояние системы (можно с историей действий) - свое название
